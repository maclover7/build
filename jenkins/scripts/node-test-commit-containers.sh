...
if [[ $NODE_NAME = *"ubuntu1604_sharedlibs_openssl110_x64"* ]]; then
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_fips20_x64"* ]]; then
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_debug_x64"* ]]; then
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_openssl102_x64"* ]]; then
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_zlib_x64"* ]]; then
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_openssl111_x64"* ]]; then
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_withoutintl_x64"* ]]; then
  PYTHON=python \
   NODE_TEST_DIR=${HOME}/node-tmp \
   FLAKY_TESTS=$FLAKY_TESTS_MODE \
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_withoutssl_x64"* ]]; then
  PYTHON=python \
   NODE_TEST_DIR=${HOME}/node-tmp \
   FLAKY_TESTS=$FLAKY_TESTS_MODE \
...
elif [[ $NODE_NAME = *"ubuntu1604_sharedlibs_shared_x64"* ]]; then
  PYTHON=python \
   NODE_TEST_DIR=${HOME}/node-tmp \
   FLAKY_TESTS=$FLAKY_TESTS_MODE \
